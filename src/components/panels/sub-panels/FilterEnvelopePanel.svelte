...
<div class="main-container">
    <!-- title -->
    <div class="title unselectable" style="grid-column: 1 / 10; grid-row: 3 / 4;">ADSR</div>
    ...
    <div style="grid-column: 8 / 10; grid-row: 5 / 6;">
...
<style>
    .main-container
    {
        ...
        display: grid;
        grid-template-columns: 16px auto 5px auto 5px auto 5px auto 16px;
